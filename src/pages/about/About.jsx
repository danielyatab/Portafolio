  ...
  return (
    <main className=" text-gray-400 mx-auto max-w-6xl ">
      <section className=" about mx-auto block text-center  mb-16">
        <h2 className="animation-top section__title text-4xl sm:text-5xl lg:text-5xl font-bold py-16 mb-12 bg-secondary lg:bg-transparent dark:text-white">
        ...
        <div className="about__container grid  lg:grid-cols-2 gap-6 text-left px-16">
          <div className='aboute__info'>
            <h3 className='animation-right section__subtitule text-xl mb-4 dark:text-gray-400'>Personal info</h3>
            <ul className='animation-left info__list grid grid-cols-1 sm:grid-cols-2 sm:gap-3 mb-4'>
              {/* Info */}
              <Info />
            </ul>
            <a href={CV} className='animation-top overflow-hidden inline-block relative text-md border border-secondary rounded-3xl py-2 pl-4 pr-16 font-bold transition-all duration-700 ease-in-out hover:bg-secondary dark:text-white hover:text-white' download=''>
              Dowland CV
          ...
          <div className="animation-left stats grid  grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-20 lg:gap-16">
            <Stats />
          </div>
        </div>
      </section>
